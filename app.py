...
LOCATION_DATABASE = {
    ...
    "2. Sakai, Tateyama, Chiba": [34.9818, 139.8523],
    "3. Shirahamacho, Minamiboso, Chiba": [34.9386, 139.9239],
    "4. Iwayada, Onjuku, Chiba": [35.1764, 140.3551],
    "5. Misakichoizumi, Isumi, Chiba": [35.2447, 140.3908],
    "6. Manatsuru, Kanagawa": [35.1558, 139.1481],
    "7. Suzaki, Shimoda, Shizuoka": [34.6465, 138.9886],
    "8. Nakagi, Minamiizu, Shizuoka": [34.6181, 138.8247],
    "9. Kumomi, Matsuzaki, Shizuoka": [34.7214, 138.7756],
    "10. Inuma, Kawanehon, Shizuoka": [35.0336, 138.1633],
    "11. Fumoto, Fujinomiya, Shizuoka": [35.3444, 138.5722],
    "12. Shoji, Fujikawaguchiko, Yamanashi": [35.4578, 138.6044],
    "13. Chisato, Achi, Nagano": [35.4300, 137.7667],
    "14. Otaki, Kiso, Nagano": [35.8672, 137.6442],
    "15. Kamikochi, Matsumoto, Nagano": [36.2428, 137.6356],
...
with col_left:
    ...
    <div class="metric-card">
        <span style="color:#94a3b8;font-size:13px;font-weight:bold;">🌌 CHẤT LƯỢNG BẦU TRỜI ĐÊM</span>
    ...
    st.markdown(f"""
    <div class="metric-card">
        <span style="color:#94a3b8;font-size:13px;font-weight:bold;">🌙 CHU KỲ MẶT TRĂNG (MOON PHASE)</span>
    ...
    st.markdown(f"""
    <div class="metric-card">
        <span style="color:#94a3b8;font-size:13px;font-weight:bold;">📍 VỊ TRÍ & TỌA ĐỘ</span>
...
with col_right:
    ...
    if weather_table_data:
        ...
        def _wind_icon(ws_str):
            ...
            if ws < 2:   icon,col = '🌬️','#94a3b8'
            elif ws < 5: icon,col = '💨','#60a5fa'
            else:        icon,col = '🌪️','#f97316'
